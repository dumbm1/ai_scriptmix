//@target illustrator
var storeObj = {
    storePath: Folder.userData + '/LocalStore/ai_scriptmix/',
...
function addStore(storeObj) {
    ...
    var storePath = storeObj.storePath,
        ...
        storeCfg = storeObj.storeCfg,
        storeImg = storeObj.storeImg,
        storeJsx = storeObj.storeJsx;
...
function delBtnFromStore(delName, storeObj) {
    var btnsList = storeObj.btnsList;
    var storeImg = storeObj.storeImg;
    var storeJsx = storeObj.storeJsx;
